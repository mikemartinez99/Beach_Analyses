# The purpose of this script is to analyze normal Pirc EPA treated relative to normal control pirc
...
groups <- meta[meta$Group == "EPA" | meta$Group == "Control",]$SampleID
...
# Save the dds object
saveRDS(dds, file = "Outputs/005_NEPA_vs_NControl_Outputs/Rds_Files/NEPA_vs_NControl_dds.Rds")
...
ggsave("Outputs/005_NEPA_vs_NControl_Outputs/DESeq2/NEPA_vs_NControl_PCA.tiff", plot, width = 12, height = 8, dpi = 100)
...
write.csv(results, file = "Outputs/005_NEPA_vs_NControl_Outputs/DESeq2/NEPA_vs_NControl_DESeq2_Results.csv")
...
GSEA_input$Symbols <- mapIds(org.Rn.eg.db, key = GSEA_input$Ensembl,
                             ...
                             multiVals = "first")
write.csv(GSEA_input, file = "Outputs/005_NEPA_vs_NControl_Outputs/GSEA/NEPA_vs_NControl_GESA_Input_List.csv")
...
saveRDS(GO, file = "Outputs/005_NEPA_vs_NControl_Outputs/Rds_Files/NEPA_vs_NControl_WT_gseGO.Rds")

# Save results as a dataframe and write to csv
GO.df <- as.data.frame(setReadable(GO, "org.Rn.eg.db", "ENTREZID"))
write.csv(GO.df, file = "Outputs/005_NEPA_vs_NControl_Outputs/GSEA/NEPA_vs_NControl_gseGO_results.csv")
...
saveRDS(KEGG, file = "Outputs/005_NEPA_vs_NControl_Outputs/Rds_Files/NEPA_vs_NControl_gseKEGG.Rds")

# Save results as a dataframe and write to csv
KEGG.df <- as.data.frame(setReadable(KEGG, "org.Rn.eg.db", "ENTREZID"))
write.csv(KEGG.df, file = "Outputs/005_NEPA_vs_NControl_Outputs/GSEA/NEPA_vs_NControlgseKEGG_results.csv")
