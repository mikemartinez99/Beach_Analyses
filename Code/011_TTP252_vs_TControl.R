...
saveRDS(dds, file = "Outputs/011_TTP252_vs_TControl_Outputs/Rds_Files/TTP252_vs_TControl_dds.Rds")
...
# Save results file
write.csv(results, file = "Outputs/011_TTP252_vs_TControl_Outputs/DESeq2/TTP252_vs_TControl_dds_results.csv")
...
# Save top DEGs file
write.csv(results005top, file = "Outputs/011_TTP252_vs_TControl_Outputs/DESeq2/TTP252_vs_TControl_Top_DEGs_Tabular_Data.csv")
...
custom_colors <- c("TP252" = "#66C2A5", "Control" = "#8DA0CB")
...
ggsave("Outputs/011_TTP252_vs_TControl_Outputs/DESeq2/TTP252_vs_TControl_PCA.tiff", plot, width = 8, height = 8, dpi = 100)
...
GSEA_input$Symbols <- mapIds(org.Rn.eg.db, key = GSEA_input$Ensembl,
                             ...
                             multiVals = "first")
write.csv(GSEA_input, file = "Outputs/011_TTP252_vs_TControl_Outputs/GSEA/TTP252_vs_TControl_GSEA_Input_List.csv")
...
saveRDS(GO.simp, file = "Outputs/011_TTP252_vs_TControl_Outputs/Rds_Files/TTP252_vs_TControl_Simplified_gseGO.rds")

# Save results as a dataframe and write to csv
GO.df <- as.data.frame(setReadable(GO.simp, "org.Rn.eg.db", "ENTREZID"))
write.csv(GO.df, file = "Outputs/011_TTP252_vs_TControl_Outputs/GSEA/TTP252_vs_TControl_Simplified_gseGO_results.csv")
...
saveRDS(KEGG, file = "Outputs/011_TTP252_vs_TControl_Outputs/Rds_Files/TTP252_vs_TControl_gseKegg.rds")

# Save results as a dataframe and write to csv
KEGG.df <- as.data.frame(setReadable(KEGG, "org.Rn.eg.db", "ENTREZID"))
write.csv(KEGG.df, file = "Outputs/011_TTP252_vs_TControl_Outputs/GSEA/TTP252_vs_TControl_gseKEGG_results.csv")
