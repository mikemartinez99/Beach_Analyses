...
ggsave("Outputs/002_Exploratory_PCA_Outputs/Final_Filtered_TumorSamples_PCA.tiff", plot, width = 12, height = 8, dpi = 300)
...
normalPCA$Group <- factor(normalPCA$Group, levels = c("WT", "Control", "Naproxen", "EPA", "Combo", "TP252", "TP252_Naproxen"))
